...
function replaceText(v) {
  ...
  v = v.replace(/\b(s)?he ([^ ]+)(s\b)/, "they $2");
  v = v.replace(/\bShe ([^ ]+)(s\b)/, "They $2");
  v = v.replace(/\bHe ([^ ]+)(s\b)/, "They $2");
  ...
  v = v.replace(/Mother/g, "Parent");
  v = v.replace(/brother/g, "sibling");
  v = v.replace(/Brother/g, "Sibling");
  v = v.replace(/(S|s)ister/g, "$1ibling");
  v = v.replace(/\b(aunt|uncle)/g, "auncle");
  v = v.replace(/\b(Aunt|Uncle)/g, "Auncle");
  v = v.replace(/\b(N|n)(iece|ephew)/g, "$1ibling");
  ...
  v = v.replace(/\b(F|f)?ire( )?(wo)?men\b/g, "$1irefighters");
  v = v.replace(/\b(F|f)?ire( )?(wo)?man\b/g, "$1irefighter");
  v = v.replace(/\b(B|b)?usiness( )?(wo)?man\b/g, "$1usinessperson");
  ...
  v = v.replace(/\bKing/g, "Monarch");
  v = v.replace(/\bQueen/g, "Monarch");
  v = v.replace(/\b(king|queen)/g, "monarch");
  v = v.replace(/\b(E|e)mpress/g, "$1mperor");
  v = v.replace(/\b(D|d)(uke|uchess)/g, "$1uke");
  v = v.replace(/\b(M|m)onk(s)?\b/g, "$1onastic$2");
  v = v.replace(/\bnun(s)?\b/g, "monastic$1");
  v = v.replace(/\bNun(s)?\b/g, "Monastic$1");
  v = v.replace(/\b(L|l)andlady?/g, "$1andlord");
  v = v.replace(/\b(P|p)riestess?/g, "$1riest");
  ...
  v = v.replace(/\bbachelorettes/g, "single people");
  v = v.replace(/\bbachelorette/g, "single person");
  v = v.replace(/\bBachelorette/g, "Single person");
  // For bachelor's degree, etc., it's typically capitalized,
  // or at least possessive.
  v = v.replace(/\bbachelor /g, "single person ");
  ...
  v = v.replace(/\b(wo)?men\b/g, "people");
